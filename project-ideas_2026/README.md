...
### 1. Pixel Watch 4 data extraction and integration (custom WearOS application)
...
### 2. Improve and modernise the Project website (radar-base.org)

Project Website: https://radar-base.org

**Overview**:
This project focuses on modernising the public RADAR-base website to better represent the platform, its community, and its impact. The current site (WordPress-based) contains valuable content but would benefit from improved information architecture, refreshed branding, and better performance, accessibility, and long-term maintainability.
The student will work closely with the RADAR-base team to redesign and implement a modern, well-structured website that clearly communicates RADAR-base’s mission, supports community engagement, and is easier for contributors to maintain and extend.

**Background & Existing Work:**
- Current website: radar-base.org (WordPress)
- RADAR-base is an open-source platform with multiple GitHub repositories covering backend services, mobile apps, and data pipelines.
- The website should better surface: Core platform capabilities (Wiki documentation); Links to GitHub repositories and documentation; Community resources (social media links, contributors, publications, adopters)

**Deliverables & Milestone:**

1. Design & information architecture: Audit existing content, propose a new site structure, and produce wireframes/mockups
2. Implementation & migration: Build the new site and migrate selected existing content
3. Performance, accessibility & SEO: Optimise performance, accessibility, and search visibility
4. Documentation & handover: Document the site structure, build process, and content management workflow

**Goals:**
By the end of the project, the student will redesign the website’s information architecture to clearly explain:

- What RADAR-base is
- Who it is for (researchers, developers, institutions)
- How to get started or contribute
- Refresh the visual design and branding while remaining consistent with RADAR-base identity
- Implement the site using a modern web framework or CMS (e.g. static site generator, headless CMS, or improved WordPress setup)
- Migrate and curate existing content, removing duplication and outdated material
...
To produce documentation so the site can be easily navigated and maintained by the team.

**Required Skills:**

- Modern web frontend frameworks (e.g. React, Vue, Svelte, or similar)
- Basic UX / visual design skills
- Experience with content management systems or static site generators
- Familiarity with accessibility and performance best practices is a plus
...
### 4. Dexcomm Continuous Glucose Monitoring (CGM) integration
...
### 5. Researcher Portal Dashboards with AI-Assisted Features
...
- **Cost estimation**: Estimate the costs and group the costs by project.
